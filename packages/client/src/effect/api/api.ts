...
type Endpoint4_19Request = Parameters<RawClient["server.session"]["session.instructions.list"]>[0]
...
export type Endpoint4_19Output = EffectValue<
  ReturnType<RawClient["server.session"]["session.instructions.list"]>
>["data"]
export type SessionInstructionsListOperation<E = never> = (
  input: Endpoint4_19Input,
) => Effect.Effect<Endpoint4_19Output, E>

type Endpoint4_20Request = Parameters<RawClient["server.session"]["session.instructions.put"]>[0]
...
export type Endpoint4_20Output = EffectValue<ReturnType<RawClient["server.session"]["session.instructions.put"]>>
export type SessionInstructionsPutOperation<E = never> = (
  input: Endpoint4_20Input,
) => Effect.Effect<Endpoint4_20Output, E>

type Endpoint4_21Request = Parameters<RawClient["server.session"]["session.instructions.remove"]>[0]
...
export type Endpoint4_21Output = EffectValue<ReturnType<RawClient["server.session"]["session.instructions.remove"]>>
export type SessionInstructionsRemoveOperation<E = never> = (
...
export interface SessionApi<E = never> {
  ...
  readonly instructions: {
    readonly list: SessionInstructionsListOperation<E>
    readonly put: SessionInstructionsPutOperation<E>
    readonly remove: SessionInstructionsRemoveOperation<E>
  }
