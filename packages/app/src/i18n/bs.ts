export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje FactorySight",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u FactorySight-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "FactorySight Cloud ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u FactorySight-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u FactorySight-u.",
  ...
  "dialog.server.description": "Promijeni na koji se FactorySight server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija FactorySight-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku FactorySight timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: FactorySight još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "FactorySight uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni FactorySight server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u FactorySight-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako FactorySight izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li FactorySight prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu FactorySight-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se FactorySight pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju FactorySight-a.",
