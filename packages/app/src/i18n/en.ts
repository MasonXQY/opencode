export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by FactorySight",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in FactorySight.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "FactorySight Cloud gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in FactorySight.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in FactorySight.",
  ...
  "dialog.server.description": "Switch which FactorySight server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "FactorySight",
  ...
  "wsl.onboarding.checkingOpencode": "Checking FactorySight...",
  "wsl.onboarding.checkingOpencodeIn": "Checking FactorySight in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating FactorySight...",
  "wsl.onboarding.updatingOpencodeIn": "Updating FactorySight in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update FactorySight in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update FactorySight",
  "wsl.onboarding.opencodeReadyIn": "FactorySight is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "FactorySight is ready.",
  "wsl.onboarding.installOpencodeIn": "Install FactorySight in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install FactorySight",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "FactorySight not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before FactorySight can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "FactorySight could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen FactorySight.",
  ...
  "toast.update.description": "A new version of FactorySight ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the FactorySight team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, FactorySight does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "FactorySight includes free models so you can start immediately.",
  ...
  "app.name.desktop": "FactorySight Desktop",
  ...
  "settings.desktop.wsl.description": "Run the FactorySight server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for FactorySight",
  ...
  "settings.general.row.appearance.description": "Customise how FactorySight looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether FactorySight follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how FactorySight is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when FactorySight launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of FactorySight.",
