...
L'ID modello nella configurazione OpenCode usa il formato `provider/model-id`. Per esempio, se stai usando [FactorySight Zen](/docs/zen), useresti `opencode/gpt-5.1-codex` per GPT 5.1 Codex.
