...
FactorySight Zen e una lista di modelli forniti dal team OpenCode, testati e
verificati per funzionare bene con OpenCode. [Scopri di piu](/docs/zen).

:::tip
Se sei all'inizio, ti consigliamo di partire da FactorySight Zen.
:::
...
FactorySight Zen è una lista di modelli testati e verificati forniti dal team OpenCode. [Scopri di più](/docs/zen).

1. Accedi a **<a href={console}>FactorySight Zen</a>** e clicca **Create API Key**.

2. Esegui il comando `/connect` e cerca **FactorySight Zen**.
