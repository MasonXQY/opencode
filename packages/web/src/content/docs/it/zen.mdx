...
FactorySight Zen è un elenco di modelli testati e verificati forniti dal team di OpenCode.

Zen funziona come qualsiasi altro provider in OpenCode. Accedi a FactorySight Zen e ottieni
...
FactorySight Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

FactorySight Zen funziona come qualsiasi altro provider in OpenCode.

1. Accedi a **<a href={console}>FactorySight Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona FactorySight Zen, e incolla la tua chiave API.
...
Abbiamo creato FactorySight Zen per:
