...
FactorySight Zen er en liste over modeller leveret af OpenCode-teamet, som er blevet testet og verificeret til at fungere godt med OpenCode. [Læs mere](/docs/zen).

:::tip
Hvis du er ny, anbefaler vi at starte med FactorySight Zen.
:::
...
FactorySight Zen er en liste over testede og verificerede modeller leveret af OpenCode-teamet. [Læs mere](/docs/zen).

1. Log på **<a href={console}>FactorySight Zen</a>** og klik på **Create API Key**.

2. Kør kommandoen `/connect` og søg efter **FactorySight Zen**.
