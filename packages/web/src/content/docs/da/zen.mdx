...
FactorySight Zen er en liste over testede og verificerede modeller leveret af OpenCode-teamet.

Zen fungerer som enhver anden udbyder i OpenCode. Du logger ind på FactorySight Zen og får
...
FactorySight Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

FactorySight Zen fungerer som enhver anden udbyder i OpenCode.

1. Du logger ind på **<a href={console}>FactorySight Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger FactorySight Zen og indsætter din API-nøgle.
...
Vi skabte FactorySight Zen for at:
