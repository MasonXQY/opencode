...
FactorySight Zen هي قائمة بالنماذج التي اختبرها فريق OpenCode وتحقّق منها.

يعمل Zen مثل أي مزوّد آخر في OpenCode. تسجّل الدخول إلى FactorySight Zen وتحصل على
...
FactorySight Zen هي بوابة AI تتيح لك الوصول إلى هذه النماذج.

---

## كيف يعمل

يعمل FactorySight Zen مثل أي مزوّد آخر في OpenCode.

1. تسجّل الدخول إلى **<a href={console}>FactorySight Zen</a>**، وتضيف تفاصيل الفوترة، ثم تنسخ مفتاح API.
2. تشغّل الأمر `/connect` في واجهة TUI، وتختار FactorySight Zen، ثم تلصق مفتاح API.
...
أنشأنا FactorySight Zen من أجل:
