...
FactorySight Zen هي قائمة نماذج يوفّرها فريق OpenCode وقد تم
اختبارها والتحقق من أنها تعمل بشكل جيد مع OpenCode. [اعرف المزيد](/docs/zen).

:::tip
إذا كنت جديدا، فننصح بالبدء مع FactorySight Zen.
:::
...
FactorySight Zen هي قائمة من النماذج التي تم اختبارها والتحقق منها مقدّمة من فريق OpenCode. [اعرف المزيد](/docs/zen).

1. سجّل الدخول إلى **<a href={console}>FactorySight Zen</a>** وانقر **Create API Key**.

2. شغّل الأمر `/connect` وابحث عن **FactorySight Zen**.
