...
The model ID in your OpenCode config uses the format `provider/model-id`. For example, if you're using [FactorySight Zen](/docs/zen), you would use `opencode/gpt-5.1-codex` for GPT 5.1 Codex.
