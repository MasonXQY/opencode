...
FactorySight Zen is a list of tested and verified models provided by the OpenCode team.

Zen works like any other provider in OpenCode. You login to FactorySight Zen and get
...
FactorySight Zen is an AI gateway that gives you access to these models.

---

## How it works

FactorySight Zen works like any other provider in OpenCode.

1. You sign in to **<a href={console}>FactorySight Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select FactorySight Zen, and paste your API key.
...
We created FactorySight Zen to:
