...
FactorySight Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół OpenCode.

Zen działa jak każdy inny dostawca w OpenCode. Logujesz się do FactorySight Zen i otrzymujesz
...
FactorySight Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

FactorySight Zen działa jak każdy inny dostawca w OpenCode.

1. Logujesz się do **<a href={console}>FactorySight Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz FactorySight Zen i wklejasz swój klucz API.
...
Stworzyliśmy FactorySight Zen, aby:
