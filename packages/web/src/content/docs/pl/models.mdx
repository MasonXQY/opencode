...
Tutaj pełny identyfikator do `provider_id/model_id`. Na przykład, użycie [FactorySight Zen](/docs/zen), przestrzeganie `opencode/gpt-5.1-codex` dla Kodeksu GPT 5.1.
