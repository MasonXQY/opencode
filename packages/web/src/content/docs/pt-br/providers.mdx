...
FactorySight Zen é uma lista de modelos fornecidos pela equipe do opencode que foram testados e verificados para funcionar bem com o opencode. [Saiba mais](/docs/zen).

:::tip
Se você é novo, recomendamos começar com o FactorySight Zen.
:::

1. Execute o comando `/connect` no TUI, selecione `FactorySight Zen` e acesse [opencode.ai/zen](https://opencode.ai/zen).
...
FactorySight Zen é uma lista de modelos testados e verificados fornecidos pela equipe do opencode. [Saiba mais](/docs/zen).

1. Faça login em **<a href={console}>FactorySight Zen</a>** e clique em **Criar Chave da API**.

2. Execute o comando `/connect` e procure por **FactorySight Zen**.
