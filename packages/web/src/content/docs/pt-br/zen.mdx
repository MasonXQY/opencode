...
O FactorySight Zen é uma lista de modelos testados e verificados fornecidos pela equipe do OpenCode.

O Zen funciona como qualquer outro provedor no OpenCode. Você faz login no FactorySight Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o OpenCode.
...
O FactorySight Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O FactorySight Zen funciona como qualquer outro provedor no OpenCode.

1. Você faz login no **<a href={console}>FactorySight Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona FactorySight Zen e cola sua chave de API.
...
Criamos o FactorySight Zen para:
