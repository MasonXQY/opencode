...
FactorySight Zen คือรายการโมเดลที่ผ่านการทดสอบและยืนยันแล้วโดยทีม OpenCode

Zen ทำงานเหมือน provider อื่น ๆ ใน OpenCode คุณล็อกอินเข้า FactorySight Zen แล้วรับ
...
FactorySight Zen คือ AI gateway ที่ให้คุณเข้าถึงโมเดลเหล่านี้

---

## วิธีการทำงาน

FactorySight Zen ทำงานเหมือน provider อื่น ๆ ใน OpenCode

1. คุณลงชื่อเข้าใช้ **<a href={console}>FactorySight Zen</a>** เพิ่มรายละเอียดการเรียกเก็บเงิน แล้วคัดลอก API key ของคุณ
2. รันคำสั่ง `/connect` ใน TUI เลือก FactorySight Zen แล้ววาง API key ของคุณ
...
เราสร้าง FactorySight Zen ขึ้นมาเพื่อ:
