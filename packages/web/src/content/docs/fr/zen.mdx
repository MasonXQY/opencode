...
FactorySight Zen est une liste de modèles testés et vérifiés fournie par l'équipe OpenCode.

Zen fonctionne comme n'importe quel autre fournisseur dans OpenCode. Vous vous connectez à FactorySight Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser OpenCode.
...
FactorySight Zen est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

FactorySight Zen fonctionne comme n'importe quel autre fournisseur dans OpenCode.

1. Vous vous connectez à **<a href={console}>FactorySight Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez FactorySight Zen et collez votre clé API.
...
Nous avons créé FactorySight Zen pour :
