...
Ici, l'identifiant complet est `provider_id/model_id`. Par exemple, si vous utilisez [FactorySight Zen](/docs/zen), vous utiliserez `opencode/gpt-5.1-codex` pour GPT 5.1 Codex.
