...
FactorySight Zen est une liste de modèles fournis par l'équipe OpenCode qui ont été
testé et vérifié pour fonctionner correctement avec OpenCode. [En savoir plus](/docs/zen).

:::tip
Si vous êtes nouveau, nous vous recommandons de commencer par FactorySight Zen.
:::
...
FactorySight Zen est une liste de modèles testés et vérifiés fournie par l'équipe OpenCode. [En savoir plus](/docs/zen).

1. Connectez-vous à **<a href={console}>FactorySight Zen</a>** et cliquez sur **Créer une clé API**.

2. Exécutez la commande `/connect` et recherchez **FactorySight Zen**.
