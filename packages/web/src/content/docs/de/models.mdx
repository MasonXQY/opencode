...
Hier ist der vollständige ID `provider_id/model_id`. Wenn Sie beispielsweise [FactorySight Zen](/docs/zen) verwenden, würden Sie `opencode/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
