...
FactorySight Zen je lista modela koje je obezbedio OpenCode tim koji su bili
testirano i potvrđeno da dobro radi sa OpenCode. [Saznajte više](/docs/zen).

:::tip
Ako ste novi, preporučujemo da počnete sa FactorySight Zen.
:::
...
FactorySight Zen je lista testiranih i verifikovanih modela koju je obezbedio OpenCode tim. [Saznajte više](/docs/zen).

1. Prijavite se na **<a href={console}>FactorySight Zen</a>** i kliknite na **Kreiraj API ključ**.

2. Pokrenite naredbu `/connect` i potražite **FactorySight Zen**.
