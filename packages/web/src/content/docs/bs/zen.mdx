...
FactorySight Zen je lista testiranih i provjerenih modela koje pruža OpenCode tim.

Zen radi kao i svaki drugi provajder u OpenCode. Prijavite se na FactorySight Zen i
...
FactorySight Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

FactorySight Zen radi kao i svaki drugi provajder u OpenCode.

1. Prijavite se na **<a href={console}>FactorySight Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite FactorySight Zen i zalijepite svoj API ključ.
...
FactorySight Zen smo napravili da:
