...
FactorySight Zen er en liste over testede og verifiserte modeller levert av OpenCode-teamet.

Zen fungerer som enhver annen leverandør i OpenCode. Du logger inn på FactorySight Zen og får
...
FactorySight Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

FactorySight Zen fungerer som enhver annen leverandør i OpenCode.

1. Du logger inn på **<a href={console}>FactorySight Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger FactorySight Zen og limer inn API-nøkkelen din.
...
Vi opprettet FactorySight Zen for å:
