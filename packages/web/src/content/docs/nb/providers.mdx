...
FactorySight Zen er en liste over modeller levert av OpenCode-teamet som har vært
testet og verifisert for å fungere godt med OpenCode. [Finn ut mer](/docs/zen).

:::tip
Hvis du er ny, anbefaler vi å starte med FactorySight Zen.
:::

1. Kjør kommandoen `/connect` i TUI, velg `FactorySight Zen` og gå til [opencode.ai/auth](https://opencode.ai/zen).
...
FactorySight Zen er en liste over testede og verifiserte modeller levert av OpenCode-teamet. [Finn ut mer](/docs/zen).

1. Logg på **<a href={console}>FactorySight Zen</a>** og klikk på **Create API Key**.

2. Kjør kommandoen `/connect` og søk etter **FactorySight Zen**.
