...
El ID del modelo en su configuración OpenCode usa el formato `provider/model-id`. Por ejemplo, si usa [FactorySight Zen](/docs/zen), usaría `opencode/gpt-5.1-codex` para GPT 5.1 Codex.
