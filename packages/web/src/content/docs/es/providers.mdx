...
FactorySight Zen es una lista de modelos proporcionados por el equipo OpenCode que han sido
probado y verificado para funcionar bien con OpenCode. [Más información](/docs/zen).

:::tip
Si eres nuevo, te recomendamos comenzar con FactorySight Zen.
:::
...
FactorySight Zen es una lista de modelos probados y verificados proporcionada por el equipo OpenCode. [Más información](/docs/zen).

1. Inicie sesión en **<a href={console}>FactorySight Zen</a>** y haga clic en **Crear API clave**.

2. Ejecute el comando `/connect` y busque **FactorySight Zen**.
