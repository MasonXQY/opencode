...
FactorySight Zen — это список протестированных и проверенных моделей, предоставленный командой OpenCode.

Zen работает как любой другой провайдер в OpenCode. Вы входите в FactorySight Zen и получаете
...
FactorySight Zen — это AI-шлюз, который дает вам доступ к этим моделям.

---

## Как это работает

FactorySight Zen работает как любой другой провайдер в OpenCode.

1. Вы входите в **<a href={console}>FactorySight Zen</a>**, добавляете платежные
   данные и копируете свой ключ API.
2. Вы запускаете команду `/connect` в TUI, выбираете FactorySight Zen и вставляете свой ключ API.
...
Мы создали FactorySight Zen, чтобы:
