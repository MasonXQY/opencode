...
const productName = channel === "prod" ? "FactorySight" : `FactorySight ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      FactorySight is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
