export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju FactorySight-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} FactorySight-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
