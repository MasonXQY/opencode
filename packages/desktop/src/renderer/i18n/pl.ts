export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji FactorySight",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} FactorySight. Czy chcesz ją zainstalować i uruchomić ponownie?",
