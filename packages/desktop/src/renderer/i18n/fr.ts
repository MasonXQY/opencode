export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'FactorySight",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'FactorySight a été téléchargée. Voulez-vous l'installer et redémarrer ?",
