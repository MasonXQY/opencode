export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von FactorySight",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von FactorySight wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
