export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de FactorySight",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de FactorySight. ¿Quieres instalarla y reiniciar?",
