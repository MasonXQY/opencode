export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من FactorySight",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من FactorySight، هل ترغب في تثبيته وإعادة تشغيله؟",
