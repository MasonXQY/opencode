export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av FactorySight",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av FactorySight er lastet ned. Vil du installere den og starte på nytt?",
