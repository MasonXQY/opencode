export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af FactorySight",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af FactorySight er blevet downloadet. Vil du installere den og genstarte?",
