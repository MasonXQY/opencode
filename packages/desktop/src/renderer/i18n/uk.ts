export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію FactorySight",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} FactorySight завантажено. Бажаєте встановити її та перезапустити?",
