...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent FactorySight from reading sensitive files",
  "Use {highlight}factorysight run{/highlight} for non-interactive scripting",
  "Use {highlight}factorysight --continue{/highlight} to resume the last session",
  "Use {highlight}factorysight run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}factorysight serve{/highlight} for headless API access to FactorySight",
  "Use {highlight}factorysight run --attach{/highlight} to connect to a running server",
  "Run {highlight}factorysight upgrade{/highlight} to update to the latest version",
  "Run {highlight}factorysight auth list{/highlight} to see all configured providers",
  "Run {highlight}factorysight agent create{/highlight} for guided agent creation",
  ...
  "Use {highlight}/connect{/highlight} with FactorySight Zen for curated, tested models",
